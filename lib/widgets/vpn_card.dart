    ...
    return Card(
        ...
        child: InkWell(
          ...
          child: ListTile(
            ...
            //title
            title: Text(vpn.countryLong, overflow: TextOverflow.ellipsis),

            //subtitle
            subtitle: Row(
              children: [
                Icon(Icons.speed_rounded, color: Colors.green, size: 20),
                SizedBox(width: 4),
            ...
            trailing: Row(
              ...
              children: [
                ...
                SizedBox(width: 4),
                Icon(CupertinoIcons.person_3_fill, color: Colors.green, size: 28,),
              ],
            ),
          ),
        ));
